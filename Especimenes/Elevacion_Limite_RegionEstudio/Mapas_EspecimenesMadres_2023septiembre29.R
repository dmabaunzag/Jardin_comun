...
####################################################################################################################################
# 1) Preliminares: caragar paquetes, leer y examinar datos.
####################################################################################################################################
...
rect(-74.30, 4.188, -74.24, 4.223, lwd=1, col="gray90")
#escala espacial
...
mtext(side=2, "B)", cex=1.5, line=-1.6, at=4.7, las=2)
...
sbar(d=1, xy = c(-74.295, 4.192), type = "bar", divs = 2, below = "", lonlat=T, label=c("0", "", "1"), adj=c(0.5,-1))
sbar(d=1, xy = c(-74.295, 4.192), type = "bar", divs = 2, below = "km", lonlat=T, label=c("", "", ""), adj=c(0.5,-1.5))
...
mtext(side=2, "A)", cex=1.5, line=-1.6, at=4.223, las=2)
...
sbar(d=30, xy = c(-74.6, 4.6), type = "bar", divs = 2, below = "km", lonlat=T, label=c("", "", ""), adj=c(0.5,-1.5))
rect(-74.65, 4.52, -74.28, 4.7)
mtext(side=2, "F)", cex=1.5, line=-1.6, at=4.7, las=2)
